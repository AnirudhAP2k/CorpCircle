        ...
        >
            { !success && !displayedError ? (
                <div className="flex justify-center items-center w-full pb-5">
                    <div role="status">
                        <svg aria-hidden="true" className="inline w-8 h-8 text-nx-outline-variant animate-spin fill-nx-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
